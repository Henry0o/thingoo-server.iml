package com.nuttu.aicloud.config;

import com.nuttu.aicloud.identity.TokenUtil;
...
//                .antMatchers("/account/**")
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        .authorizeRequests()
                ...
                .antMatchers(HttpMethod.POST,"/account/gateway/*").permitAll()
                .antMatchers(HttpMethod.GET,"/account/activate").permitAll()
                .antMatchers(HttpMethod.GET,"/webSocket/**").permitAll()
                .antMatchers(HttpMethod.GET,"/ws/**").permitAll()
                .antMatchers(HttpMethod.POST,"/gateways/addHealthCode").permitAll()
                .antMatchers(HttpMethod.POST,"/healthInfos").permitAll()
                .antMatchers(HttpMethod.POST,"/healthInfos/report").permitAll()
